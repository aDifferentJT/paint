...
import paint/internal/types.{
  type Image, type PathSegment, type Picture, Arc, Blank, Combine, Fill,
  FontProperties, Image, NoStroke, Path, Polygon, Radians, Rotate, Scale,
  SolidStroke, Stroke, Text, Translate,
}
